...
@pytest.fixture()
def es_records_n(app, db, db_index, location, db_itemtype2,db_oaischema):
    ...
    with app.test_request_context():
        for i in range(1, 10):
            ...
            'item_1617186419668': {'attribute_name': 'Creator', 'attribute_type': 'object', 'attribute_value_mlt': [{'iscreator':'is'.format(i)},{'givenNames': [{'givenName': "givenNames".format(i)}, {'givenNameLang':"ja"}]},{"familyNames":[{"familyName":"mei"},{"familyNameLang":"ja"}]},{"familyNames":[{"familyName":"mei"},{"familyNameLang":"ja"}]}
