...
# from invenio_communities.models import WidgetDesignPage
from invenio_communities import models as WidgetDesignPage
# from .api import WidgetItems
# from .config import WEKO_COMMUNITIES_ACCESS_COUNTER_TYPE
...
def index():
    ...
    return render_template(
        # "weko_communities/index.html",
        "weko_communities/base.html",
        # module_name=_('weko-communities'))
        module_name='weko-communities')
...
def view_widget_page():
    ...
    try:
        ...
        if page.settings:
            main_type = current_app.config['WEKO_COMMUNITIES_MAIN_TYPE']
        ...
        return render_template(
            page.template_name
            or current_app.config['WEKO_COMMUNITIES_BASE_TEMPLATE'],
            page=page,
...
def _add_url_rule(url_or_urls):
    ...
    map(lambda url:
        current_app.add_url_rule(url, 'weko_communities.view_widget_page',
...
def dbsession_clean(exception):
    current_app.logger.debug("weko_communities dbsession_clean: {}".format(exception))
