...
g = {}
with open(os.path.join('weko_communities', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
    version = g['__version__']

setup(
    name='weko-communities',
    version=version,
    description=__doc__,
    long_description=readme + '\n\n' + history,
    keywords='weko communities',
    license='MIT',
    author='National Institute of Informatics',
    author_email='wekosoftware@nii.ac.jp',
    url='https://github.com/wekosoftware/weko-communities',
    packages=packages,
    zip_safe=False,
    ...
    entry_points={
        'flask.commands': [
            'widget_type = weko_communities.cli:widget_type',
            'widget = weko_communities.cli:widget',
        ],
        # 'invenio_base.apps': [
        #     'weko_communities = weko_communities:Wekocommunities',
        #     'weko_communities_rss = weko_communities:Wekocommunities',
        # ],
        # 'invenio_base.api_blueprints': [
        #     'weko_communities = weko_communities.views:blueprint_api',
        # ],
        # 'invenio_admin.views': [
        #     'weko_communities_widget = weko_communities.admin:widget_adminview',
        #     'weko_communities_widget_design = '
        #     'weko_communities.admin:widget_design_adminview',
        # ],
        'invenio_i18n.translations': [
            'messages = weko_communities',
        ],
        # 'invenio_db.models': [
